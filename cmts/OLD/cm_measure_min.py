...
# ------------- Get measure items -------------------------------------------
SQL = "select oid, ip_type, v_type, operator,id from cm_measure_item where id in ('86','101','102','113','1','2','3','87','94','95')  order by id"
rst = ora_nms.execall(SQL)
if rst is None:
    ...
    if len(rst)>0:
        ...
        while cmtsidx<cmts['COUNT']:
            ...
            for aw in rst:
                ...
                mitem[str(cmtsidx)+'-ID-'+str(i)] = aw[4]
