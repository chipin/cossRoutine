...
while 1:
    ...
    if exec_time-pre_exec_time>300:
        ...
        cmtssql = "select a.companyno,a.cmts_id,a.ip,a.snmp_ro, \
                   case \
                     when upper(b.maker||b.model) like '%%UBR%%' then 'UBR' when upper(b.maker||b.model) like '%%CBR%%' then 'CBR' \
        ...
        while cmts_idx<cmts_cnt:
            try:
                ...
                print xso, xcmtsid, xIP, xcomm, xmodel
                ...
                if xmodel=='ARRIS' and xcpu is not None and xcpu != -1:
								    xcpu=100-xcpu
