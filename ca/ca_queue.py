...
querySql = "select sid,icc_no,stb_no,cmd,bg_date,end_date,channel,mail,tune,networkid,product_name,ppvdate from v_ca_queue where rownum<=30 and sourceid is not null and sourceid='%d'" % (sourceid)
                        ...
                        for a_row in rs:
                            try:
                                ...
                                if cmd=='A1':
                                    ...
                                    resp = cafunc.gw_reboot_interactive2(sid, bg_date, end_date, icc_no)
                                else:
                                    resp = -2
                                if resp<0:
