...
class CAGW_FUNC:
    ...
    def gw_cancel_icc(self, sid, bgd, endd, icc):
        ...
        if self.gw_combo('01',sid, bgd, endd, iccs, '0051')<0:
            self.rollback_q(1)
            return -1
        if self.gw_combo('02',sid, bgd, endd, iccs, '005200000000000000')<0:
            self.rollback_q(2)
            return -1
        return 1
    ...
    def gw_cancel_icc_no_cancel(self, sid, bgd, endd, icc):
        ...
        if self.gw_combo('00',sid, bgd, endd, iccs, '0051')<0:
            return -1
        if self.gw_combo('01',sid, bgd, endd, iccs, '005200000000000000')<0:
            self.rollback_q(1)
            return -1
        return 1
    ...
    def gw_cancel_all_prod(self, sid, bgd, endd, icc):
        iccs = icc[:10]
        if self.gw_combo('00',sid, bgd, endd, iccs, '0007')<0:
            return -1
        return 1
