        ...
        while 1:
            try:
                ...
                if nop_flag>0:
                    nop_flag = 0
                if sock is None:
                    sock = gw_open("10.20.111.11",60002)
                    if sock is None:
