...
where a.account='IPMONv2' and a.close_date is null and a.normal_flag in ('A','B') and a.type in ('3111','4304') and a.status not in ('5029','5125') and a.impact_list like '%%-%%' and a.special_flag is not null and a.create_date > to_date('2018/01/01','YYYY/MM/DD') and a.location='%s'" % (so)
    #print qry_sql
