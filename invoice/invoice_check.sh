...
progname="invoice_check.py"

today=`date '+%Y%m'`
logname1="/ap/home/coss/log/invoice/invoice_check_TFM_${today}.log"
logname2="/ap/home/coss/log/invoice/invoice_check_KBRO_${today}.log"
logname3="/ap/home/coss/log/invoice/invoice_check_CG_${today}.log"
