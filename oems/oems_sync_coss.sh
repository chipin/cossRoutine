...
progname="oems_sync_coss.py"
thismonth=`date '+%Y%m'`

logname1="${homepath}/log/oems/oems_sync_coss_TFM_${thismonth}.log"
logname2="${homepath}/log/oems/oems_sync_coss_KBRO_${thismonth}.log"
logname3="${homepath}/log/oems/oems_sync_coss_CG_${thismonth}.log"
