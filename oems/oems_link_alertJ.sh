...
progname="oems_link_alertJ.py"
thismonth=`date '+%Y%m'`

logname1="${homepath}/log/oems/oems_link_alertJ_TFM_${thismonth}.log"
logname2="${homepath}/log/oems/oems_link_alertJ_KBRO_${thismonth}.log"
logname3="${homepath}/log/oems/oems_link_alertJ_CG_${thismonth}.log"
